...
class BudgetDaySettingsScreen extends StatelessWidget {
  const BudgetDaySettingsScreen({super.key});
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Container(
              ...
              child: Consumer<BudgetDayProvider>(
                builder: (context, budgetDayProvider, child) {
                  return ListView.builder(
                    padding: EdgeInsets.all(sizer.sp(12)),
                    itemCount: 31,
                    itemBuilder: (context, index) {
                      final day = index + 1;
                      final isSelected = day == budgetDayProvider.budgetDay;
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            await budgetDayProvider.setBudgetDay(day, paymentProvider);
